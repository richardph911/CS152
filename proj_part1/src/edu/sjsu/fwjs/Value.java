...
/**
 * Values in FWJS. Evaluating a FWJS expression should return a FWJS value.
 */
...
/**
 * A closure. Note that a closure remembers its surrounding scope.
 */
class ClosureVal implements Value {
	...
	/**
	 * The environment is the environment where the function was created. This
	 * design is what makes this expression a closure.
	 */
