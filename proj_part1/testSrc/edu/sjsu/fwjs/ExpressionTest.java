...
public class ExpressionTest {
    ...
    //     Environment env = new Environment();
    //     BinOpExpr boe = new BinOpExpr(Op.SUBTRACT,
    //             new ValueExpr(new IntVal(12)),
    //             new ValueExpr(new IntVal(2)));
    //     IntVal iv = (IntVal) boe.evaluate(env);
    ...
    //     Environment env = new Environment();
    //     BinOpExpr boe = new BinOpExpr(Op.MULTIPLY,
    //             new ValueExpr(new IntVal(1)),
    //             new ValueExpr(new IntVal(2)));
    //     IntVal iv = (IntVal) boe.evaluate(env);
    ...
    //     Environment env = new Environment();
    //     BinOpExpr boe = new BinOpExpr(Op.DIVIDE,
    //             new ValueExpr(new IntVal(6)),
    ...
    //     Environment env = new Environment();
    //     BinOpExpr boe = new BinOpExpr(Op.EQ,
    //             new ValueExpr(new IntVal(6)),
    //             new ValueExpr(new IntVal(3)));
    //     IntVal iv = (IntVal) boe.evaluate(env);
