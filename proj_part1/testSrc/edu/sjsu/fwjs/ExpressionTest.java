...
public class ExpressionTest {
	...
	@Test
	public void testBinOpExprSub() {
		Environment env = new Environment();
		BinOpExpr boe = new BinOpExpr(Op.SUBTRACT, new ValueExpr(new IntVal(12)), new ValueExpr(new IntVal(2)));
		IntVal iv = (IntVal) boe.evaluate(env);
	...
	public void testBinOpExprMul() {
		Environment env = new Environment();
		BinOpExpr boe = new BinOpExpr(Op.MULTIPLY, new ValueExpr(new IntVal(1)), new ValueExpr(new IntVal(2)));
		IntVal iv = (IntVal) boe.evaluate(env);
		assertEquals(iv, new IntVal(2));
	}

	@Test
	public void testBinOpExprDiv() {
		Environment env = new Environment();
		BinOpExpr boe = new BinOpExpr(Op.DIVIDE, new ValueExpr(new IntVal(6)), new ValueExpr(new IntVal(3)));
		IntVal iv = (IntVal) boe.evaluate(env);
		assertEquals(iv, new IntVal(2));
	}

	@Test
	public void testBinOpExprNotEqu() {
		Environment env = new Environment();
		BinOpExpr boe = new BinOpExpr(Op.EQ, new ValueExpr(new IntVal(6)), new ValueExpr(new IntVal(3)));
		Value iv = boe.evaluate(env);
		assertEquals(iv, new BoolVal(false));
	}

	@Test
	public void testBinOpExprEqu() {
		Environment env = new Environment();
		BinOpExpr boe = new BinOpExpr(Op.EQ, new ValueExpr(new IntVal(6)), new ValueExpr(new IntVal(6)));
		Value iv = boe.evaluate(env);
		assertEquals(iv, new BoolVal(true));
	}

	@Test
	public void testBinOpExprGE() {
		Environment env = new Environment();
		BinOpExpr boe = new BinOpExpr(Op.GE, new ValueExpr(new IntVal(6)), new ValueExpr(new IntVal(8)));
		Value iv = boe.evaluate(env);
		assertEquals(iv, new BoolVal(false));
	}
	@Test
	...
	public void testBinOpExprMOD() {
		Environment env = new Environment();
		BinOpExpr boe = new BinOpExpr(Op.MOD, new ValueExpr(new IntVal(6)), new ValueExpr(new IntVal(4)));
		Value iv = boe.evaluate(env);
		assertEquals(iv, new IntVal(2));
	}
	 ...
	 @Test
	 public void testBadWhileExpr() {
	 Environment env = new Environment();
	 env.updateVar("x", new IntVal(10));
	 WhileExpr we = new WhileExpr(new ValueExpr(new IntVal(0)),
	 new AssignExpr("x",
	 new BinOpExpr(Op.SUBTRACT,
	 new VarExpr("x"),
	 new ValueExpr(new IntVal(1)))));
	 ...
	 new VarExpr("x"));
	 SeqExpr seq = new SeqExpr(newVar, new FunctionAppExpr(f, new
